...
gmsh.model.add("cooks_membrane_refine_single_corner") #In this example without transfinite meshes

lc = 10 #Meshsize

gmsh.model.geo.addPoint(0, 0, 0, lc, 1)
gmsh.model.geo.addPoint(0, 44, 0, lc, 2)
gmsh.model.geo.addPoint(48, 60, 0, lc*0.01, 3) #refinement * 100 on this corner
...
gmsh.write("cooks_membrane_refine_single_corner.msh")
