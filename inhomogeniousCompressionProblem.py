...
num_points_length = 50  # Number of points along the length
num_points_height = 10  # Number of points along the height
gmsh.model.geo.mesh.setTransfiniteCurve(1, num_points_length)
gmsh.model.geo.mesh.setTransfiniteCurve(2, num_points_height)
gmsh.model.geo.mesh.setTransfiniteCurve(3, num_points_length)
gmsh.model.geo.mesh.setTransfiniteCurve(4, num_points_height)
...
gmsh.model.mesh.field.setNumber(2, "VIn", lc / 5)
